"""
Django settings for ossdeployment project.
...
SECRET_KEY = 'django-insecure-emc6uv7+4cf=@$y()jik847%1boae*kl(&h%z3lg^79srrnfz2'
...
ROOT_URLCONF = 'ossdeployment.urls'
...
WSGI_APPLICATION = 'ossdeployment.wsgi.application'
